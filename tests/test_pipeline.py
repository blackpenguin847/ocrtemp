...
from estimate_ocr.exporter import SHEET_RESULT, SHEET_REVIEW
...
GOOD_JSON = json.dumps(
    {
        ...
        "소계": 5000,
        "품목": [
            {"품명": "레미콘", "규격": "25-24-150", "단위": "㎥", "수량": 2, "단가": 1500, "금액": 3000},
            {"품명": "펌프카", "규격": "", "단위": "대", "수량": 1, "단가": 2000, "금액": 2000},
        ],
    },
    ensure_ascii=False,
)
...
def test_export_all_formats(sample_pdf, tmp_path):
    ...
    assert [cell.value for cell in sheet[1]][:4] == ["원본PDF", "페이지", "문서번호", "품명"]
